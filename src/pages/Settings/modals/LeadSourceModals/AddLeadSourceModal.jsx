...
const AddLeadSourceModal = ({ showModal, onClose, onCallApi }) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${BASE_URL}/add-lead-source`, dataToSend, config)
      .then((res) => {
        onCallApi();
        handleClose();
        if (res?.data?.message) {
  ...
  return (
    <Modal title={"Add Lead Source"} desc={"This source will be accessible for any contact that is owned by Tri-Oak Consulting Group"} show={showModal} onClose={handleClose}>
