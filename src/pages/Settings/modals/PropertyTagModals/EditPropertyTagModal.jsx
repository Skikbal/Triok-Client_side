...
const EditPropertyTagModal = ({ showModal, onClose, onCallApi, name, id }) => {
  ...
  const handleSubmit = (e) => {
    ...
    setDisable(true);
    axios
      .post(`${BASE_URL}/update-propertytag/${id}`, { tag_name: tagName }, config)
      .then((res) => {
        onCallApi();
        handleClose();
      })
  ...
  return (
    <Modal title={"Edit Property Tag"} desc={"This tag will be accessible for item owned by Tri-Oak Consulting Group"} show={showModal} onClose={handleClose}>
      <form className="mt-3" onSubmit={handleSubmit}>
        <div>
          ...
          <input
            ...
            name="tagName"
            type="text"
            placeholder="enter property tag name here....."
            value={tagName}
            onChange={(e) => {
              setError();
...
export default EditPropertyTagModal;
